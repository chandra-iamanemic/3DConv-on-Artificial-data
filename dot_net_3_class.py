# -*- coding: utf-8 -*-
"""
Created on Thu Mar  7 17:33:09 2019
...
history = model.fit(X_train,Y_train,batch_size = 32, epochs=1, validation_split = 0.1, shuffle = 'True')


model.save("C:/Users/cks/Documents/practice codes/dot_3d_cnn_models/model_3_class.h5")
...
#new_model = load_model("C:/Users/cks/Documents/practice codes/model_3_class.h5")
#
#new_model.summary()
#w = np.array(new_model.get_weights())
...
motion_list = ["Vertical","Horizontal","Diagonal"]
